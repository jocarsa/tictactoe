...
DRAW_FPS = 10  # Increased FPS to make the game faster
...
def main():
    ...
    out = cv2.VideoWriter('tic_tac_toe_faster.mp4', cv2.VideoWriter_fourcc(*'mp4v'), DRAW_FPS, (WIDTH, HEIGHT))

    for _ in range(200):  # Increased the number of moves to make the video 1 minute long
